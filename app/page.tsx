        ...
        {/* @ts-ignore */}
          ...
          <div className="flex h-full  items-start justify-center w-[100%] gap-[1rem]">
            <main className="main-content  max-h-[100%] overflow-y-auto flex flex-col gap-[2rem] h-full w-[70vw] px-[1rem] ">
              <div className="top-main flex gap-[2rem] min-h-[35%] max-h-[35%] pb-[2rem] overflow-x-auto max-w-full scroll-smooth ">
                <ChartCard
              ...
              <div className="bottom-main flex min-h-[80%]  max-w-[100%] gap-[2rem] items-center overflow-x-auto scroll-smooth" >
                <SavingsCard />
                <StatisticsCard />
              </div>
            </main>
