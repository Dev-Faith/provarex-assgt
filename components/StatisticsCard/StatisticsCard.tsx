...
const StatisticsCard = () => {
  return (
    <div className="border border-gray-200 rounded-[1rem] w-2/5 md:w-full p-[1rem] flex flex-col gap-[2.5rem] py-[2rem] px-[1.5rem] h-auto">
      ...
      <div>
        <div className="mini-card h-auto py-[2rem] px-[2rem] bg-gray-200 rounded-[2rem] flex justify-between ">
          <CircularProgressBar value={88} max={100} />
          <div className="list-itemss w-full justify-end">
